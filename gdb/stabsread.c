		...
		xmalloc (type_vector_length * sizeof (struct type *));
              if (save_type_vector) {
                all_type_vector = (struct type **)
                  xmalloc (type_vector_length * sizeof (struct type *));
                all_type_index = (int *)xmalloc (type_vector_length * sizeof (int));
              }
	  ...
	  memset (&type_vector[old_len], 0,
        ...
        if (save_type_vector)
        {
          ...
          memset (&all_type_vector[old_len], 0,
                  (type_vector_length - old_len) * sizeof (struct type *));
          all_type_index = (int *)xmalloc (type_vector_length * sizeof (int));
          memset (all_type_index, 0, (type_vector_length - old_len) * sizeof (int));
         }
      }
  ...
  switch (type_descriptor)
	...
	*dbx_lookup_type (typenums, objfile) = type;
    ...
    case 'm':
      ...
      all_type_index[typenums[1]] = typenums[1];
      all_type_count += 1;
      break;
